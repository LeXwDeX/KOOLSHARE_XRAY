		...
		<div class="content">
			...
			<script type="text/javascript">
				$('#xray_node_urladd_pannel').forms([
					{ title: '通过vmess链接添加节点</br></br><font color="#B2B2B2"># 可一次添加多个vmess://链接<br /># 每个链接以空格分隔</font>', name: 'xray_base64_links',type:'textarea', value: dbus.xray_base64_links, style: 'width: 100%; height:100px;' }
				]);
			</script>
